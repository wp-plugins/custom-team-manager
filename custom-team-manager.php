...
function register_style() {
    wp_register_style( 'stylesheet', plugins_url('/css/stylesheet.css', __FILE__), false, '2.2.1', 'all');
}
...
function cmt_wp_admin_style() {
        wp_register_style( 'cmt_admin_css', plugins_url('/css/admin-style.css', __File__), false, '2.2.1', 'all' );
